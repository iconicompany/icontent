 ...
 * **Temporal Cloud:** Продукт класса SaaS (Software-as-a-Service). Компании больше не нужно администрировать сложный Temporal Server и базы данных — они платят за количество запущенных действий, делегируя поддержку команде Temporal.
