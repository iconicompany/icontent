 ...
 * **Двухуровневая генерация:** Модель работает в два шага. Сначала она предсказывает будущий высокоуровневый блок (абстрактный концепт) и только затем, используя его как железобетонный смысловой каркас, генерирует финальные текстовые токены.
...
В итоге мы получаем комбинаторно огромное пространство возможных концептов:
