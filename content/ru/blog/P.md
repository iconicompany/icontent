...
Проектируя любую систему с помощью ИИ, мы оперируем тремя уровнями:
 ...
 3. **Реализация (Implementation)** — конкретная архитектура, паттерны и стек (микросервисы или монолит, кэширование, структура БД).
...
**Что делать?**
 1. **Отрежьте архитектуру от требований.** Опишите в намерениях целевые метрики (нагрузку, отказоустойчивость, безопасность), но позвольте системе самой адаптировать код под эти параметры.
