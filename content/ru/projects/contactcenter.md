...
date: '2020-03-01'
description: "Создание микросервисной экосистемы для управления маркетинговыми кампаниями, сегментации клиентов и автоматизации работы операторов контакт-центра"
